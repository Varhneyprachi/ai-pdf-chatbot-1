...
Below is the result generated by the PDF Question–Answering App:
...
© 2025 — Developed by **Prachi Varshney**.  
All rights reserved.  
Unauthorized copying of this project, via any medium, is strictly prohibited unless permission is granted.
